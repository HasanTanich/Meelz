...
@Component({
  selector: 'app-menu-details-carousel',
  templateUrl: './menu-details-carousel.component.html',
  styleUrls: ['./menu-details-carousel.component.css'],
...
export class MenuDetailsCarouselComponent implements OnInit, OnDestroy {
  @Input()
  slides;
  @Input()
